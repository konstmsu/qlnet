...
// bma leg
        ...
        protected override void initializeDates() {
            ...
            Schedule bmaSchedule = new MakeSchedule(_settings).from(earliestDate_).to(maturity)
            ...
            Schedule liborSchedule = new MakeSchedule(_settings).from(earliestDate_).to(maturity)
